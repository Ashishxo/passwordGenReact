      ...
      <div className='flex justify-center w-full h-screen bg-[rgb(13,17,23)] items-center'>
          <div className='flex flex-col justify-center w-[45%]'>
            <div className='w-full bg-[rgb(22,27,34)] px-5 py-5 rounded-3xl shadow-2xl'> 
              ...
              <button className='duration-200 px-3 py-2 rounded-r-3xl bg-gradient-to-r from-[#8A2387] via-[#E94057] to-[#F27121] text-[#ccc] hover:from-[#b02aa9] hover:via-[#f73c55] hover:to-[#ff8b43] shadow-xl w-1/6  active:from-[#8A2387] active:via-[#E94057] active:to-[#F27121]' onClick={copyToClipboard}>Copy</button>
